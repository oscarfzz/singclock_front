...
class _$UserEntityImpl extends _UserEntity {
  _$UserEntityImpl({required this.id, required this.username}) : super._();
...
abstract class _UserEntity extends UserEntity {
  factory _UserEntity({required final int id, required final String username}) =
      _$UserEntityImpl;
...
abstract class $AuthUserCopyWith<$Res> {
  ...
  @useResult
  $Res call({PhoneModel user, String token});
}
...
abstract class _AuthUser implements AuthUser {
  factory _AuthUser(
      {required final PhoneModel user,
