...
mixin _$ChatParticipantEntity {
  ...
  int get idGrp => throw _privateConstructorUsedError;
...
abstract class $ChatParticipantEntityCopyWith<$Res> {
  ...
  $Res call(
      {int id,
      @JsonKey(name: "chat_id") int idGrp,
...
class _$ChatParticipantEntityCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      idGrp: null == idGrp
          ? _value.idGrp
          : idGrp // ignore: cast_nullable_to_non_nullable
              as int,
      userId: null == userId
          ? _value.userId
...
class _$ChatParticipantEntityImpl implements _ChatParticipantEntity {
  _$ChatParticipantEntityImpl(
      {required this.id,
      @JsonKey(name: "chat_id") required this.idGrp,
  ...
  @override
  String toString() {
    return 'ChatParticipantEntity(id: $id, idGrp: $idGrp, userId: $userId, user: $user)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.idGrp, idGrp) || other.idGrp == idGrp) &&
...
abstract class _ChatParticipantEntity implements ChatParticipantEntity {
  factory _ChatParticipantEntity(
      ...
      @JsonKey(name: "chat_id") required final int idGrp,
